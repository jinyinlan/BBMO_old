...
def main(args):
	...
	if args.mode == 'test':
		...
		#test_dataset = FlickrInteresting('flickr-sup.csv', '/home/omiya/data/test-set0811/supplemental/degraded_photos/chosen', input_transform_testval, 'test')
		#test_dataset = FlickrInteresting('omiya-data.csv', '/home/omiya/data/omiya_photo1203/original_photos/', input_transform_testval, 'test')
		
		test_loader = DataLoader(test_dataset, num_workers=args.num_workers, batch_size=1, shuffle=False, drop_last=False)
		datadir = args.datadir
		test(test_loader, model, testdir, dst, args.iteration)
