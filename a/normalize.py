...
def normalize(param): #normalize parameter value by train data
	...
	"""
	#2016-09_2017-12
	mean = np.array([ 0.00019, 0.00038, 51.68072, 0.00026, -53.04044, 73.35190, 52.01958,
					0.00024, 0.00041, 0.47265, 0.96978, 0.94532, 0.93164, 26.38616,
					0.00020, 0.00017, 0.00016, 0.00022, 0.75903, 0.82752, 1.03499 ])
	std = np.array([ 0.00397, 0.00260, 32.87102, 0.00269, 25.69292, 23.77706, 18.15760,
					0.00263, 0.00367, 0.20749, 0.50417, 0.47204, 0.51336, 10.91563,
					0.00263, 0.00258, 0.00269, 0.00274, 0.42436, 0.41313, 0.44567 ])
...
def denormalize(normalized_param): #denormalize parameter value by train data
	...
	csvFileName = '/home/omiya/data/flickr_teacherData0312/train/flickr-parameters_2017-11-20_2017-12-14-train.csv'
	...
	for i in range(len(fileName)):
		root_dirName = '/home/omiya/data/flickr_teacherData0312/parameters/'
		num = fileName[i]
		name = num[:22]
...
if __name__ == '__main__':
	...
	#print denormalized_param
	
	#print np.mean(normalized_param) #all_params:0
	#print np.var(normalized_param) #all_params:1
